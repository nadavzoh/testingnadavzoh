...
class BasicLineModelFactory(LineModelFactory):
    ...
    def create_line_model_copy(self, line_model: BasicLineModel) -> BasicLineModel:
        """
        Create a deep copy of an existing BasicLineModel instance.
        Args:
            line_model: The BasicLineModel instance to copy
        Returns:
            BasicLineModel: A new BasicLineModel instance with the same content
        """
        return BasicLineModel(line_model.get_content())
