...
class LineModelFactory(ABC):
    ...
    @abstractmethod
    def create_line_model_copy(self, line_model: LineModelInterface) -> LineModelInterface:
        """
        Create a deep copy of an existing line model instance.
        
        Args:
            line_model: The line model instance to copy
            
        Returns:
            LineModelInterface: A new line model instance with the same content
        """
        pass
